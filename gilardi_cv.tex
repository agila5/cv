...
\begin{document}
  ...
  \vspace{-0.65cm}
  \section{Summary}
  \cvitem{}{I am a research fellow in Statistics at the University of Milano - Bicocca, Department of Economics, Management and Statistics (\underline{\href{https://dems.unimib.it/en}{DEMS}}). My main research interests are spatial and spatiotemporal models on road networks.}
  ...
  \cvitemwithcomment{Teaching Assistant}{\underline{\href{https://bnews.unimib.it/blog/lab-data-challenges-la-sfida-che-proietta-gli-studenti-nel-mondo-del-lavoro}{Lab Data Challanges}}, University of Milano - Bicocca}{FEB.21--MAY.21}
  ...
  \cvitemwithcomment{Tutor}{Introduction to R, University of Milano - Bicocca. \underline{\href{https://github.com/agila5/bbetween_R}{Materials}}.}{MAR.19--APR.19}
  ...
  \cventry{JAN.21--Present}{Research fellow}{University of Milano - Bicocca}{Milan (Italy)}{}{}{}
  ...
  \item \textbf{Gilardi, A.}, Borgoni, R., Presicce, L., \& Mateu, J., Measurement error models on spatial network lattices: car crashes in Leeds in BOOK OF ABSTRACTS AND SHORT PAPERS 13th Scientific Meeting of the Classification and Data Analysis Group  Firenze, September 9-11, 2021; 
  \item \textbf{Gilardi, A.}, Borgoni, R., \& Mateu, J. (2021). A spatio-temporal model for events on road networks: an application to ambulance interventions in Milan. Preface XIX 1 Plenary Sessions, 702.
  ...
  \cvlistitem{I was a member of the Local Organizing Committee of \underline{\href{https://www.nesputt2019.unimib.it/}{Nesputt 2019: New Economic \& Statistical Perspective}} conference, Milan (Italy).}
  ...
  \cvitem{}{\underline{\href{https://www.sciencedirect.com/journal/spatial-statistics}{Spatial Statistics}};
  \vspace*{0.15cm}
  \underline{\href{https://ropensci.org/}{rOpenSci}}}
