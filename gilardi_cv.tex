...
\begin{document}
  ...
  \cventry{JUN. 23 - Today}{Assistant Professor (RTDA)}{Politecnico di Milano}{Milan, Italy}{}{I am working on a project named \href{https://grins.it/}{\emph{GRINS: Growing Resilient, INclusive and Sustainable}} which is part of the Next Generation EU program (National Recovery and Resilience Plan).}
  ...
  \cvlistitem{\emph{Livellamento al Software R} (Introduction to the R Software), University of Milano - Bicocca, Master degree in Statistics and Economics, 14 hours per year, aa.yy. 2022-2023; 2023-2024.}
  ...
  \cvlistitem{\emph{Basics of Statistics and Biomedical Signals}, Politecnico di Milano, Bachelor degree in Biomedical Engineering, 15 hours, a.y. 2023-2024. \href{https://www11.ceda.polimi.it/schedaincarico/schedaincarico/controller/scheda_pubblica/SchedaPublic.do?&evn_default=evento&c_classe=814742&polij_device_category=DESKTOP&__pj0=0&__pj1=927113422d0217831d0aa418b9d7ff27}{Details}.}
   \cvlistitem{\emph{Statistica II} (Statistics II), University of Milano - Bicocca, Bachelor degree in Statistical and Economic Sciences, 20 hours per year, aa.yy. 2017-2018; 2022-2023; 2023-2024.}
  ...
  \cventry{NOV. 23 - DEC.23}{Professor}{POLIMI Graduate School of Management}{Milan, Italy}{}{I held a 16 hours course entitled "Analytics - Tools di Analisi" for approximately 30 employees of \href{https://www.acea.it/}{ACEA}. We focused on descriptive and exploratory statistics, supervised and unsupervised clustering techniques, and principal components analysis with practical examples in JASP.}
  ...
  \cventry{JUN.20--OCT.20 \& JUN.21 -- OCT.21 \& JUN.22 -- OCT.22 \& JUN.23--OCT.23}{Tutor}{University of Milano - Bicocca}{Milan (Italy)}{}{I prepared and organized the admission tests for the master degree in Statistics and Economics, Department of Economics, Management and Statistics.}
  ...
  \cvlistitem{\emph{Corso di Formazione Tavolo territoriale | Elementi di geo-statistica e microsimulazione spaziale.} This is a workshop organised by PoliS and Istat that will be held online and in presence at the end of June 2024. I will present a talk which is entitled \emph{Incidentalità stradale in Lombardia}. }
  \cvlistitem{\emph{GRINS Workshop: Geostatistical harmonisation of large environmental and climate datasets for the AMELIA platform: inter-spoke coordination and first results}}
  ...
  \cvlistitem{\emph{Robust Statistics : Foundations and Recent Developments}, University of Milano-Bicocca, March 2019.}
  \cvlistitem{\emph{CLADAG, Summer School on Clustering and Classification}, University of Catania - May 2018.}
  
  \section{Conferences}
  
  \subsection{Invited}
  \cvlistitem{65th ISI World Statistics Congress 2025, The Hague (Netherlands)}
  \cvlistitem{Statalk, 30-31 May 2024, Department of Statistics, Computer Science, Applications G. Parenti, University of Florence (Italy)}
  \cvlistitem{2023 IMS International Conference on Statistics and Data Science (ICSDS), December 18-21, 2023, Lisbon (Portugal)}
  \cvlistitem{15th International Conference of the ERCIM WG on Computational and Methodological Statistics (CMStatistics 17-19 December 2022) - King’s College London, London (United Kingdom).}
  \cvlistitem{Summer Institute in Computational Social Science (SICSS-Covenant), 22-29 June 2022, Covenant University, Ogun State (Nigeria). Online.}
  \cvlistitem{OpenGeoHub Summer School 2021, 1-3 September 2021, Online Event.}
  
  \subsection{Contributed}
  \cvlistitem{METMA XI, 11th International Workshop on Spatio-Temporal Modelling, 23-25 July 2024, Lancaster (United Kingdom)}
  \cvlistitem{52th meeting of the Italian Statistical Society,  17 - 20 June 2024, Bari (Italy)}
  ...
  \cvlistitem{METMA X, 10th International Workshop on Spatio-Temporal Modelling, 1-3 June 2022, Lleida (Spain)}
  ...
  \subsection{Attended}
  \cvlistitem{Statalk, September 15th, 2023, Università di Roma - Sapienza (Italy).}
  ...
  \cvlistitem{I'm organizing a session for the CFE-CMStatistics 2024 conference which will be held at King's College London (UK) from December, 14th to December, 16th 2024.}
  \cvlistitem{I'm a member of the Organizing Committee of the Mathematics for planet Earth (M4E) Workshop. This workshop will be held on November 11-12, 2024 at Politecnico di Milano (Italy)}
  ...
  \href{https://www.nature.com/srep/}{Scientific Reports} (2); \href{https://www.sciencedirect.com/journal/spatial-statistics}{Spatial Statistics} (3); \href{https://www.springer.com/journal/10260}{Statistical Methods \& Applications} (1); \href{https://www.tandfonline.com/journals/utch20}{Technometrics} (1).}
  \vspace*{0.15cm}
