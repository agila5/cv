...
\begin{document}
  ...
  \section{Summary}
  \cvitem{}{I am a research fellow in Statistics at the University of Milano - Bicocca, Department of Economics, Management and Statistics (DEMS). My main research interests are spatial and spatiotemporal models on road networks.}
  
  \hypersetup{
  	pdfborderstyle={/S/U/W 0.5}, % underline links instead of boxes
  ...
  \cventry{SET.15--OTT.17}{Master Degree in Statistics}{University of Milano - Bicocca}{}{}{Final mark: 110/110 e lode (Magna cum laude)} 
  \cventry{SET.12--SET.15}{Bachelor Degree in Statistics}{Università of Milano - Bicocca}{}{}{Final mark: 110/110 e lode (Magna cum laude)}
	
  \section{Teaching}
  \cvitemwithcomment{Teaching Assistant}{Introduction to Statistical Inference, University of Milano - Bicocca}{SEP.17--FEB.22}
  \cvitemwithcomment{Teaching Assistant}{\href{https://bnews.unimib.it/blog/lab-data-challenges-la-sfida-che-proietta-gli-studenti-nel-mondo-del-lavoro}{Lab Data Challenges}, University of Milano - Bicocca}{FEB.21--MAY.21}
  \cvitemwithcomment{Teaching Assistant}{R for Road Safety. RAC Foundation.  \href{https://www.racfoundation.org/introduction-to-r-for-road-safety}{Program} and \href{https://cran.r-project.org/web/packages/stats19/vignettes/stats19-training.html}{Materials}.}{OCT.19--OCT.19}
  \cvitemwithcomment{Tutor}{Introduction to R, University of Milano - Bicocca. \href{https://github.com/agila5/bbetween_R}{Materials}.}{MAR.19--APR.19}
  ...
  \cvitemwithcomment{Teaching Assistant}{Economic Statistics, University of Milano - Bicocca}{APR.18--JUL.18}
  \cvitemwithcomment{Teaching Assistant}{Informatics, University of Milano - Bicocca}{MAY.17--SEP.17}

  \section{Working Experience}
  \cventry{JAN.21--Present}{Research fellow}{University of Milano - Bicocca}{Milan (Italy)}{}{I worked on a project entitled "Spatio-temporal models for spatial network data".}{}{}
  \cventry{OCT.20--NOV.20}{Consultant}{Catholic University of the Sacred Heart}{Milan (Italy)}{}{I worked on a project named \textit{Black Box and Big Data per la stima e la previsione dei sinistri} under the supervision of \href{https://docenti.unicatt.it/ppd2/it/docenti/04485/diego-zappa/profilo}{Prof. Diego Zappa}.}
  % \cventry{JUN.20--OCT.20 \& JUN.21 -- Present}{Tutor}{University of Milano - Bicocca}{Milan (Italy)}{}{I prepared and organized the admission tests for the Department of Economics, Management and Statistics.}
  ...
  \cvlistitem{I spent seven months in Castellón de la Plana (ES), from February 2020 to June 2020 and May 2021 to July 2021, working with \href{https://www3.uji.es/~mateu/}{Prof. Jorge Mateu} on statistical models for events on road networks.}
  \cvlistitem{I stayed in Leeds (UK) for three months, from September 2019 to November 2019, working with \href{https://environment.leeds.ac.uk/transport/staff/953/dr-robin-lovelace}{Prof. Robin Lovelace} on R packages and classes for road networks. \href{https://github.com/agila5/leeds_seminar}{Final presentation}.}
  ...
  \item \textbf{Gilardi, A.}, Mateu, J., Borgoni, R., Lovelace, R., Multivariate hierarchical analysis of car crashes data considering a spatial network lattice. Accepted for publication in the \textit{Journal of the Royal Statistical Society: Series A}. \href{https://arxiv.org/abs/2011.12595}{Preprint};
  \item \textbf{Gilardi, A.}, Borgoni, R., Presicce, L., \& Mateu, J., Measurement error models on spatial network lattices: car crashes in Leeds. In 13th Scientific Meeting of the Classification and Data Analysis Group , Firenze, September 9-11, 2021. \url{https://doi.org/10.36253/978-88-5518-340-6}; 
  ...
  \cvlistitem{Contributing to R, Online workshop held during useR! 2021}
  \cvlistitem{Spatial Statistics for huge datasets and best practices, Online workshop held during useR! 2021}
  ...
  \cvlistitem{CLADAG 2021, 13th Scientific Meeting Classification and Data Analysis Group, Online, September 9-11, 2021}
  ...
  \section{Grants}
  \cvlistitem{\href{https://www.r-consortium.org/projects/awarded-projects/2019-group-2\#Tidy+spatial+networks+in+R}{Tidy Spatial Networks in R} funded by the \href{https://www.r-consortium.org/}{R Consortium}. 9000\$}
  
  \section{Awards}
  \cvlistitem{Scolarship for the OpenGeoHub 2020 - Summer School. Project: \textit{plotKML functionality to support sf and stars objects}. \href{https://www.youtube.com/watch?v=n3SjuJIEnKY&list=PLXUoTpMa_9s0Ea--KTV1OEvgxg-AMEOGv&index=42}{Final presentation}.}
  ...
  \cvitem{}{\href{https://www.springer.com/journal/10182}{AStA Advances in Statistical Analysis}; \href{https://www.sciencedirect.com/journal/spatial-statistics}{Spatial Statistics}; 
  \href{https://ropensci.org/}{rOpenSci}.} 
  \vspace*{0.15cm}
  \cvitem{}{\textcolor{myblue}{\textbf{Affiliations}}}
  \cvitem{}{Società Italiana di Statistica (SIS); \href{https://ropensci.org/}{rOpenSci}}.
